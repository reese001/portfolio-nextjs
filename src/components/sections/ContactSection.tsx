...
export function ContactSection({ sendMail }: ContactSectionProps) {
  ...
  return (
    <section id="contact" className="relative w-full bg-black min-h-screen">
      {isMounted ? (
          <WavyBackground className="w-full" colors={['#27272a', '#3f3f46', '#18181b', '#52525b']}>
            <div className="container mx-auto px-4 py-10 w-full">
              <h1 className="text-7xl tracking-tight bg-clip-text bg-gradient-to-r from-white via-neutral-300 to-neutral-500 text-transparent font-semibold mb-16 text-center">
                Contact Me
              </h1>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start max-w-6xl mx-auto">
                {/* Left Column - Contact Information */}
                <div className="backdrop-blur-sm bg-black/20 p-8 rounded-xl border border-gray-800 flex flex-col space-y-6">
                  ...
                  <div className="pt-6">
                    <h3 className="text-xl font-medium text-gray-200 mb-4">Connect With Me</h3>
                    <div className="flex space-x-4">
                      <a href="https://github.com/reese001" target="_blank" className="bg-zinc-800/80 p-3 rounded-full hover:bg-zinc-700/80 transition-colors">
                      ...
                      <a href="https://www.linkedin.com/in/reese-parsons/" target="_blank" className="bg-zinc-800/80 p-3 rounded-full hover:bg-zinc-700/80 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="text-gray-300" viewBox="0 0 16 16">
                ...
                <div className="backdrop-blur-sm bg-black/20 p-8 rounded-xl border border-gray-800">
                  <h2 className="text-2xl font-bold bg-clip-text bg-gradient-to-r from-white to-gray-300 text-transparent mb-6">Send a Message</h2>
                  {showSuccess && (
                  ...
                  <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="space-y-2 text-left">
                      <label htmlFor="name" className="text-sm font-medium text-gray-300 pb-1">
                        Name
                      </label>
                      <Input
                        type="text"
                      ...
                      <ReCaptchaProvider onChange={setCaptcha}>
                        ...
                        <div className="w-full">
                          <button
                            ...
                            className="w-full bg-white hover:bg-gray-200 text-black py-2 font-medium rounded-md hover:cursor-pointer transition-colors"
                          >
        ...
        <WavyBackground className="w-full min-h-screen" colors={['#27272a', '#3f3f46', '#18181b', '#52525b']}>
